...
# ==========================================
# 🛑 SAARI DETAILS PEHLE SE SET HAIN (No edit needed except Owner ID)
# ==========================================
BOT_TOKEN = "8293793841:AAFrKiukw_OqwXzGsFf4ZAI2jSfPEAdobro" 
OWNER_ID = 123456789  # <--- SIRF YE EK NUMBER BADALNA HAI (Apna ID yahan daalein)
...
# Channels ke bina @ ke IDs
FSUB_CHANNELS = ["O_Q5wllImjw3NTRl", "joy_webs", "LQ787BPSnFYxOWY1"] 

bot = telebot.TeleBot(BOT_TOKEN)

# ==========================================
# 🔒 FORCE SUBSCRIBE (Bina join kiye kuch kaam nahi karega)
# ==========================================
...
def check_subscription(message):
    if not is_subscribed(message.from_user.id):
        ...
        btn_verify = types.InlineKeyboardButton("✅ Verify Check Karo", callback_data="verify")
        markup.add(btn1)
        markup.add(btn2)
        markup.add(btn3)
        ...
        bot.reply_to(message, 
            ...
            "Neeche buttons dabayein aur phir 'Verify Check Karo' par click karein.", 
...
# ==========================================
# ⚡ COMMANDS (Har command pe check hoga)
# ==========================================
...
def start_command(message):
    ...
    bot.reply_to(message, f"🔥 *WELCOME TO {BOT_NAME}* 🔥\n\n"
                          "Yeh ek khatarnak, advanced aur high-speed bot hai.\n"
                          "Neeche /help dabakar saare commands dekhein.\n\n"
                          f"👑 *Owner:* {OWNER_USERNAME}", parse_mode='Markdown', reply_markup=markup)

# 2. ID (Chat ID aur User ID)
